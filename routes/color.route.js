...
router.route("/updateColor/:id").put(authenticateToken, requireAdmin, controller.updateColor);
router.route("/deleteColor/:id").delete(authenticateToken, requireAdmin, controller.deleteColor);
