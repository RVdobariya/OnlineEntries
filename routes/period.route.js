...
router.route("/updatePeriod/:id").put(authenticateToken, requireAdmin, controller.updatePeriod);
router.route("/deletePeriod/:id").delete(authenticateToken, requireAdmin, controller.deletePeriod);
